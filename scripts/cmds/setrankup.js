...
module.exports = {
	config: {
		...
		guide: {
			...
			ar: '   {pn} نص <رسالة>: تكوين الرسالة عند ترقية عضو في مربع الدردشة الخاص بك'
                + '\n   مع الإختصارات التالية:'
                + '\n    + {userName}: اسم العضو'
                + '\n    + {userNameTag}: علامة اسم العضو'
                + '\n    + {oldRank}: رتبة العضو القديمة'
                + '\n    + {currentRank}: الرتبة الحالية للعضو'
                + '\n   {pn} مجلد <link>: تكوين ملف المرفق عند ترقية عضو في مربع الدردشة الخاص بك'
                + '\n   {pn} تصفير: إعادة تعيين إلى التكوين الافتراضي'
		}
	},
	...
	langs: {
		...
		ar: {
			changedMessage: "تم تغيير إشعار المستوى الى: %1",
			missingAttachment: "يجب عليك الرد على الصور",
			changedAttachment: "تك إرفاق %1 صور أو مقاطع."
		}
	},
