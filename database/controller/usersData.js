...
module.exports = async function (databaseType, userModel, api, fakeGraphql) {
	...
	async function getAvatarUrl(userID) {
		...
		try {
			...
			return `https://graph.facebook.com/${userID}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662` ??  "https://i.ibb.co/bBSpr5v/143086968-2856368904622192-1959732218791162458-n.png";
		}
	}
