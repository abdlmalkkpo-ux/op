...
module.exports = {
	config: {
		...
		description: {
			...
			ar: "إرسال رسالة للمطورين و الرد ربي و زهرك 🌚"
		},
		category: "contact",
		guide: {
			vi: "   {pn} <tin nhắn>",
			en: "   {pn} <message>",
			ar: "   {pn} <رسالتك مثلا اقترح فكرة أمر جديد '-'>"
		}
	},
	...
	langs: {
		...
		ar: {
			missingMessage: "لازم تحط الرسالة اللي تريد ترسلها في الأمر 🌚",
			sendByGroup: "\n- أرسل من مجموعة: %1\n- معرفها: %2",
			sendByUser: "\n- أرسل من طرف شخص",
			content: "\n\nالمحتوى:\n─────────────────\n%1\n─────────────────\nرد اذا أردت إرسال رسالة للمستخدم",
			success: "وصلت رسالتك ل %1 أدمنز بنجاح!\n%2",
			failed: "حدث خطأ أثناء ارسال رسالتك الى  %1 مشرف\n%2\nالتفاصيل في الكونصول",
			reply: "📍 رد المطور %1:\n─────────────────\n%2\n─────────────────\nرد على هذه الرسالة لمتابعة الحديث معه",
			replySuccess: "وصل ردك بنجاح للأدمن!",
			feedback: "📝 رد المستخدم %1:\n- معرفه: %2%3\n\nالرسالة:\n─────────────────\n%4\n─────────────────\nيمكنك الرد عليه من خلال الرد على هذه الرسالة ",
			replyUserSuccess: "تم وصل ردك للمستخدم بنجاح!",
			noAdmin: "البوت لا يملك مشرفين حاليا"
		}
	},
	...
	onStart: async function ({ args, message, event, usersData, threadsData, api, commandName, getLang }) {
		...
		const msg = "==📨️ إتصال للأدمن 📨️=="
			+ `\n- إسم الشخص: ${senderName}`
			+ `\n- معرف الشخص: ${senderID}`
