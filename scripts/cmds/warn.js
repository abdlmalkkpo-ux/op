...
module.exports = {
	config: {
		...
		description: {
			...
			ar: "تحذير الأشخاص و من يحذر 3 مرات يطرد."
		},
		category: "box chat",
		guide: {
			...
			ar: "   {pn} @tag <سبب>: تحذير عضو"
                + "\n   {pn} قائمة: عرض قائمة الأعضاء المحذرين"
                + "\n   {pn} قائمةالبان: عرض قائمة الأعضاء المحظورين"
                + "\n   {pn} معلومات [@tag | <معرف المستخدم> | رد | اتركه فارغ]: عرض معلومات التحذير للشخص المذكور أو معرف المستخدم أو نفسك"
                + "\n   {pn} فك [@tag | <معرف المستخدم> | رد | اتركه فارغ]: إلغاء حظر العضو، وفي نفس الوقت إزالة جميع التحذيرات لهذا العضو"
                + "\n   {pn} نووارن [@tag | <معرف المستخدم> | رد | اتركه فارغ] [<رقم> | اتركه فارغ]: إزالة تحذير العضو حسب معرف المستخدم ورقم التحذير، إذا ترك فارغًا سيتم إزالة التحذير الأخير"
                + "\n   {pn} تصفير: إعادة تعيين جميع بيانات التحذير"
                + "\n⚠️ تحتاج إلى تعيين المسؤول للروبوت لطرد الأعضاء المحظورين تلقائيًا"
		}
	},
	...
	langs: {
		...
		ar: {
	        list: "قائمة الأعضاء الذين تم تحذيرهم:\n%1\n\nلعرض تفاصيل التحذيرات، استخدم الأمر \"%2warn info [@tag | <معرف المستخدم> | اتركه فارغ]\": لعرض معلومات التحذير للشخص المذكور أو معرف المستخدم أو نفسك",
        	listBan: "قائمة الأعضاء الذين تم تحذيرهم 3 مرات وحظرهم من المجموعة:\n%1",
	        listEmpty: "مجموعتك ليس لديها أعضاء تم تحذيرهم",
	        listBanEmpty: "مجموعتك ليس لديها أعضاء محظورين من المجموعة",
	        invalidUid: "يرجى إدخال معرف مستخدم صالح للشخص الذي تريد عرض معلوماته",
	        noData: "لا توجد بيانات",
	        noPermission: "❌ فقط مسؤولو المجموعة يمكنهم إلغاء حظر الأعضاء المحظورين من المجموعة",
	        invalidUid2: "⚠️ يرجى إدخال معرف مستخدم صالح للشخص الذي تريد إلغاء حظره",
	        notBanned: "⚠️ المستخدم بمعرف %1 لم يتم حظره من مجموعتك",
	        unbanSuccess: "✅ تم إلغاء حظر العضو [%1 | %2] بنجاح، حاليًا يمكن لهذا الشخص الانضمام إلى مجموعتك",
	        noPermission2: "❌ فقط مسؤولو المجموعة يمكنهم إزالة التحذيرات من الأعضاء في المجموعة",
	        invalidUid3: "⚠️ يرجى إدخال معرف مستخدم أو وسم الشخص الذي تريد إزالة التحذير منه",
	        noData2: "⚠️ المستخدم بمعرف %1 ليس لديه بيانات تحذير",
	        notEnoughWarn: "❌ المستخدم %1 لديه فقط %2 تحذيرات",
	        unwarnSuccess: "✅ تم إزالة التحذير %1 بنجاح من العضو [%2 | %3]",
	        noPermission3: "❌ فقط مسؤولو المجموعة يمكنهم إعادة تعيين بيانات التحذير",
	        resetWarnSuccess: "✅ تم إعادة تعيين بيانات التحذير بنجاح",
	        noPermission4: "❌ فقط مسؤولو المجموعة يمكنهم تحذير الأعضاء في المجموعة",
	        invalidUid4: "⚠️ تحتاج إلى وسم أو الرد على رسالة الشخص الذي تريد تحذيره",
	        warnSuccess: "⚠️ تم تحذير العضو %1 مرات %2\n- معرف المستخدم: %3\n- السبب: %4\n- التاريخ والوقت: %5\nتم تحذير هذا العضو 3 مرات وحظره من المجموعة، لإلغاء الحظر استخدم الأمر \"%6warn unban <معرف المستخدم>\" (مع معرف المستخدم هو معرف الشخص الذي تريد إلغاء حظره)",
	        noPermission5: "⚠️ يحتاج الروبوت إلى أذونات المسؤول لطرد الأعضاء المحظورين",
	        warnSuccess2: "⚠️ تم تحذير العضو %1 %2 مرات\n- معرف المستخدم: %3\n- السبب: %4\n- التاريخ والوقت: %5\nإذا انتهك هذا الشخص %6 مرات أخرى، سيتم حظره من المجموعة",
	        hasBanned: "⚠️ الأعضاء التالية أسماؤهم تم تحذيرهم 3 مرات سابقًا وحظرهم من المجموعة:\n%1",
	        failedKick: "⚠️ حدث خطأ عند طرد الأعضاء التالية أسماؤهم:\n%1",
	        userNotInGroup: "⚠️ المستخدم \"%1\" ليس حاليًا في مجموعتك"
       }
	},
