...
module.exports = {
	config: {
		...
		guide: {
			...
			ar: '   {pn} اضف <كلمة> => <رد>: إضافة اختصار لك (يمكنك إرسال رسالة أو الرد على رسالة مع مرفق لإضافة المرفق)'
                + '\n   مثال:\n    {pn} اضف هاي => مرحباً بالجميع'
                + '\n'
                + '\n   {pn} حذف <word>: حذف اختصار'
                + '\n   مثال:\n    {pn} حذف هاي'
                + '\n'
                + '\n   {pn} إزالة: إزالة جميع الاختصارات في محادثة المجموعة الخاصة بك'
                + '\n'
                + '\n   {pn} قائمة: عرض قائمة اختصاراتك'
                + '\n   {pn} قائمة start <keyword>: عرض قائمة اختصاراتك التي تبدأ بـ <keyword>'
                + '\n   {pn} قائمة end <keyword>: عرض قائمة اختصاراتك التي تنتهي بـ <keyword>'
                + '\n   {pn} قائمة contain <keyword>: عرض قائمة اختصاراتك التي تحتوي على <keyword>'
		}
	},
	...
	langs: {
		...
		ar: {
            ...
            shortcutExists: 'الاختصار "%1" موجود بالفعل، رد على هذه الرسالة لاستبدال محتوى الاختصار',
            shortcutExistsByOther: 'الاختصار %1 تمت إضافته بواسطة عضو آخر، الرجاء استخدام كلمة مفتاحية أخرى',
            added: 'تمت إضافة الاختصار %1 => %2',
            addedAttachment: ' مع %1 مرفق(ات)',
            missingKey: 'الرجاء إدخال كلمة المفتاح للاختصار الذي ترغب في حذفه',
            notFound: 'لا يوجد اختصار لكلمة المفتاح %1 في محادثة المجموعة الخاصة بك',
            onlyAdmin: 'يمكن للمسؤولين فقط حذف اختصارات الآخرين',
            deleted: 'تم حذف الاختصار %1',
            empty: 'لم يتم إضافة أي اختصارات إلى محادثة مجموعتك',
            message: 'رسالة',
            attachment: 'مرفق',
            list: 'قائمة اختصاراتك',
            listWithTypeStart: 'قائمة اختصارات مجموعتك (تبدأ بـ "%1")',
            listWithTypeEnd: 'قائمة اختصارات مجموعتك (تنتهي بـ "%1")',
            listWithTypeContain: 'قائمة اختصارات مجموعتك (تحتوي على "%1")',
            listWithTypeStartNot: 'مجموعتك لا تحتوي على أي اختصارات تبدأ بـ "%1"',
            listWithTypeEndNot: 'مجموعتك لا تحتوي على أي اختصارات تنتهي بـ "%1"',
            listWithTypeContainNot: 'مجموعتك لا تحتوي على أي اختصارات تحتوي على "%1"',
            onlyAdminRemoveAll: 'يمكن للمسؤولين فقط إزالة جميع الاختصارات في محادثة المجموعة',
            confirmRemoveAll: 'هل أنت متأكد من أنك تريد إزالة جميع الاختصارات في هذه المحادثة؟ (رد على هذه الرسالة للتأكيد)',
            removedAll: 'تمت إزالة جميع الاختصارات في محادثة مجموعتك'
       }
	},
...
async function createShortcut(key, content, attachments, threadID, senderID) {
	console.log(key, content, attachments, threadID, senderID);
	let attachmentIDs = [];
