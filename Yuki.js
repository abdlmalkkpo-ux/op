...
function getLineFunc(i) {
  const consoleWidth = 25;//process.stdout.columns;
  let text;
...
process.on('uncaughtException', error => console.log(error));
	...
	try {
		...
		throw new Error("Token expired ! or revoked get new one.");
	}
	...
	const parentIdGoogleDrive = await utils.drive.checkAndCreateParentFolder("YukiBot");
