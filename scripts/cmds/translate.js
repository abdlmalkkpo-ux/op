...
module.exports = {
	...
	langs: {
		...
		ar: {
	        translateTo: "🌐 الترجمة من %1 إلى %2",
        	invalidArgument: "❌ حجة غير صالحة، يرجى اختيار تشغيل أو إيقاف",
	        turnOnTransWhenReaction: `✅ تم تفعيل ترجمة الرسائل عند التفاعل، حاول التفاعل برمز \"${defaultEmojiTranslate}\" لأي رسالة لترجمتها (لا تدعم رسائل الروبوت)\n سيتم ترجمة الرسائل فقط بعد تفعيل هذه الميزة`,
	        turnOffTransWhenReaction: "✅ تم إيقاف ترجمة الرسائل عند التفاعل",
	        inputEmoji: "🌀 يرجى التفاعل مع هذه الرسالة لتعيين هذا الرمز كرمز لترجمة الرسائل",
	        emojiSet: "✅ تم تعيين رمز ترجمة الرسائل إلى %1"
       }
	},
