...
module.exports = {
	config: {
		name: "notification",
		aliases: ["اشعار", "إشعار", "notify", "noti"],
		version: "1.7",
	...
	langs: {
		...
		ar: {
			missingMessage: "أدخل الرسالة",
			notification: "رسالة من المطور لكل مجموعات اللي فيها البوت (لا ترد على هذه الرسالة).",
			sendingNotification: "توجد %1 مجموعات، جاري الارسال...",
			sentNotification: "✅ الرسالة وصلت الى %1 مجموعة بنجاح.",
			errorSendingNotification: "❎ حدث خطأ مع %1 مجموعة:\n%2"
		}
	},
