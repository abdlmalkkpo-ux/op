...
module.exports = {
	config: {
		name: "emojimean",
		aliases: ["معنى", "em", "emojimeaning", "emojimean"],
		version: "1.4",
	...
	langs: {
		...
		ar: {
			...
			meaningOfEmoji: "📌 معنى الإيموجي  %1:\n\n📄 أول معنى: %2\n\n📑 المزيد من المعاني: %3%4\n\n📄 الشورت كود: %5\n\n©️ المصدر: %6\n\n📺 صور الإيموجي في مواقع مختلفة:",
			meaningOfWikipedia: "\n\n📝 سوي رياكشن اذا تريد ترى معنى  \"%1\" في ويكيبيديا",
			meanOfWikipedia: "📑 معنى  \"%1\" في ويكيبيديا:\n%2",
			manyRequest: "⚠️ البوت أرسل عدة طلبات من فضلك جرب لاحقا",
			notHave: "ليس له أي معنى"
		}
	},
