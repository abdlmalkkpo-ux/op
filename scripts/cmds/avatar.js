...
module.exports = {
	config: {
		...
		guide: {
			...
			ar: "{pn} <اسم شخصية انمي بالإنجليزي > | نص الخلفية | توقيع | لون الخلفية بالإنجليزي او هيكس كود"
		}
	},
	...
	langs: {
		...
		ar: {
			initImage: "📩 يتم استقبال الصورة، انتضر خمس دقائق...",
			invalidCharacter: "❎ يوجد %1 شخصيات في النظام من فضلك ادخل رقم احداها بدل الاسم.",
			notFoundCharacter: "لا توجد صورة %1 حاليا",
			errorGetCharacter: "❎ حدثت مشكلة حاول لاحقا:\n%1: %2",
			success: "✅ تصميمك جاهز\nالشخصية : %1\nرقم: %2\nالنص: %3\nالتوقيع: %4\nاللون: %5",
			defaultColor: "default",
			error: "حدث خطأ ❎\n%1: %2"
		}
