module.exports = {
	...
	langs: {
		...
		ar: {
			warn: "تم تحذير العضو %1 ثلاث مرات من قبل وتم حظره من صندوق الدردشة\n- الاسم: %1\n- معرف المستخدم: %2\n- لإلغاء الحظر، يرجى استخدام الأمر \"%3تحذير فك <ايدي>\" (مع معرف المستخدم هو معرف الشخص الذي ترغب في إلغاء حظره)",
			needPermission: "الروبوت بحاجة إلى إذن المسؤول لطرد الأعضاء المحظورين"
		}
	},
