...
module.exports = {
	config: {
		...
		description: {
			...
			ar: "تشغيل/إيقاف ميزة منع تغيير معلومات صندوق الدردشة"
		},
		category: "box chat",
		guide: {
			...
			ar: "   {pn} avt [تشغيل | إيقاف]: منع تغيير صورة رمزية صندوق الدردشة"
				+ "\n   {pn} name [تشغيل | إيقاف]: منع تغيير اسم صندوق الدردشة"
				+ "\n   {pn} nickname [تشغيل | إيقاف]: منع تغيير لقب في صندوق الدردشة"
				+ "\n   {pn} theme [تشغيل | إيقاف]: منع تغيير الثيم (الموضوع) في صندوق الدردشة"
				+ "\n   {pn} emoji [تشغيل | إيقاف]: منع تغيير الرموز التعبيرية في صندوق الدردشة"
		}
	},
	...
	langs: {
		...
		ar: {
			antiChangeAvatarOn: "تم تفعيل ميزة منع تغيير صورة رمزية صندوق الدردشة",
			antiChangeAvatarOff: "تم إيقاف ميزة منع تغيير صورة رمزية صندوق الدردشة",
			missingAvt: "لم تقم بتعيين صورة رمزية لصندوق الدردشة",
			antiChangeNameOn: "تم تفعيل ميزة منع تغيير اسم صندوق الدردشة",
			antiChangeNameOff: "تم إيقاف ميزة منع تغيير اسم صندوق الدردشة",
			antiChangeNicknameOn: "تم تفعيل ميزة منع تغيير لقب صندوق الدردشة",
			antiChangeNicknameOff: "تم إيقاف ميزة منع تغيير لقب صندوق الدردشة",
			antiChangeThemeOn: "تم تفعيل ميزة منع تغيير ثيم (موضوع) صندوق الدردشة",
			antiChangeThemeOff: "تم إيقاف ميزة منع تغيير ثيم (موضوع) صندوق الدردشة",
			antiChangeEmojiOn: "تم تفعيل ميزة منع تغيير الرموز التعبيرية في صندوق الدردشة",
			antiChangeEmojiOff: "تم إيقاف ميزة منع تغيير الرموز التعبيرية في صندوق الدردشة",
			antiChangeAvatarAlreadyOn: "صندوق الدردشة الخاص بك مُفعل فيه حاليًا ميزة منع تغيير الصورة الرمزية",
			antiChangeAvatarAlreadyOnButMissingAvt: "صندوق الدردشة الخاص بك مُفعل فيه حاليًا ميزة منع تغيير الصورة الرمزية ولكن لم يتم تعيين صورة رمزية",
			antiChangeNameAlreadyOn: "صندوق الدردشة الخاص بك مُفعل فيه حاليًا ميزة منع تغيير الاسم",
			antiChangeNicknameAlreadyOn: "صندوق الدردشة الخاص بك مُفعل فيه حاليًا ميزة منع تغيير اللقب",
			antiChangeThemeAlreadyOn: "صندوق الدردشة الخاص بك مُفعل فيه حاليًا ميزة منع تغيير الثيم (الموضوع)",
			antiChangeEmojiAlreadyOn: "صندوق الدردشة الخاص بك مُفعل فيه حاليًا ميزة منع تغيير الرموز التعبيرية"
		}
	},
