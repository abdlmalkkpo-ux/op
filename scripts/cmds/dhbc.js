...
module.exports = {
	config: {
		...
		description: {
			...
			ar: "لعبة ليست عربية. تجاهلها لو سمحت"
		},
		category: "game",
		guide: {
			en: "{pn}"
	...
	langs: {
		...
		ar: {
			reply: "رد على هذه الرسالة بالجواب 🌚\n%1",
			isSong: "إسم صوت أغنية المغني %1",
			notPlayer: "⚠️ أنت مش اللاعب",
			correct: "🎉 صحيح لقد ربحت  %1 دينار",
			wrong: "⚠️ جواب غلط حاول مجددا."
		}
	},
